...
CREATE POLICY IF NOT EXISTS "Service role can insert order items"
...
CREATE POLICY IF NOT EXISTS "Users can view their payment signatures"
...
CREATE POLICY IF NOT EXISTS "Service role can insert payment signatures"
ON public.payment_signatures FOR INSERT
WITH CHECK (true);

-- Service role can update signatures
CREATE POLICY IF NOT EXISTS "Service role can update payment signatures"
